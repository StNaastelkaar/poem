const choices = [
   { id: "undefined",
    ...
    body: "Darius zette zich lekker schrap, <br> een gloednieuw spel, oh dat is geen grap! <br> En terwijl hij het spel onder ogen zag,",
    options: [
    ...
    options: [
     ...
     { id: "apoc-01", name: "wanneer hij de geheimen van het universum ontleedt." }
    ]
   }, {
    id: "thesis-02", title: "",
    ...
    id: "speler-01", title: "",
    body: "Een priester, of <i> warlock </i>, een kattige heks, <br> (die twee-in-één krijgers waren toch wat complex) <br> een grote barbaar als koning gekleed, <br> of een jeukend figuur dat men liever vergeet. <br> Talloze heldendaden zal hij nog verrichten,",
    options: [
     {id: "generic-END", name: "ja, als speler draagt Darius duizend gezichten!"}
    ]
   }, {
    id: "gm-01", title: "",
    body: "Met een <i> stroke </i> van zijn pen, en wat dobbelstenen <br> kan Darius de mooiste werelden mansplainen. <br> Zo creëert hij voor zijn vrienden wel uren aan pret, <br> met Disneyplagiaat of een privé-toilet, <br> met mythen en sagen en ambigu gelegen zee,",
    options: [
     {id: "generic-END", name: "of economische topics à la David G."}
    ]
   }, {
    id: "cbs-01", title: "",
    ...
    id: "dad-01", title: "",
    body: "\"Ik ben zoveel meer dan een ambtenaar\", <br> en inderdaad, niets is minder waar. <br> Een hoeder van drie magnefieken telgen, <br> doen Darius niet zomaar overweldigen! <br> \"Het Vaderschap\", aldus Darius, \"is een zwaar gevecht\"",
    options: [
    ...
    id: "hitman-02", title: "",
    body: "Maar goed, nu dus, uhm, aller eerst <br> dit spel dat Darius blijkbaar goed heeft beheerst. <br> Keurig ging hij langs mijn menu's, <br> en een reeks saaie opties passeerde de revues <br> Maar zijn keuzes waren wel erg conservatief,",
    options: [
    ...
    body: "En wat blijkt onze Darius is management materiaal, <br> dus hem wacht een promotie tot directeur-generaal. <br> Waar hij met zijn visie een stempel zal drukken <br> en met zijn hervormingen de boel zal ontfucken. <br> En met lintjes, en toasten en een afscheidscomité",
    options: [
    ...
    options: [
     ...
     {id: "END", name:"misschien is het beter als we dit achter ons laten en je iets met je cadeau doet of zo."},
    ]  
   }, {
    id: "apoc-01", title: "THE END (TIMES)",
    body: "Met zijn nieuw ijzeren theorieën, <br>werpt hij de wereld op zijn knieën. <br> Want kennis is macht, en macht corrumpeert, <br> en zo ook Darius wanneer hij de wereld beheert. <br> De zeeën zullen koken, de onschuldigen gillen <br> wanneer hij de aarde onder ze doet rillen. <br> En hoewel men hem om mededogen zal smeken,",
    options: [
     {id: "apoc-END", name:"maakt men geen omelet zonder eieren te breken!"}
    ]  
   }, {
    id: "pytrik-01", title: "",
    body: "Een spel dat voor hem een historisch portaal is, <br> het roemruchte Europa Universalis! <br> Met tientallen uitbreidingen tot zijn beschikking, <br> Speelt hij als Turk, Spanjaard of Viking. <br> En voor hem geen gedoe met consoles of Tv's, <br> een lid is hij immers, van het PC <i>master-race!</i> <br> Een stoïsche jongen, al van kind-af-aans,",
    options: [
    ...
    options: [
     {id: "pytrik-END", name: "dat hij en Pytrik dezelfde persoon zijn!"}
    ]
   }, {
    ...
    id: "rijm-END-A", title: "",
    body: "Cadeaus en vriendschap, <br> verbroederende giften, <br> op Sint Naastelkaar.",
    options: [
     {id: "intro-01", name:"\"Dankjewel, erg mooi, ik zal het nog een keer proberen.\""},
     {id: "END", name:"\"Uhm ja, dankjewel. Ik ga nu toch even naar het echte cadeau.\""},
    ]
   }, {
    id: "board-01", title: "",
    body: "Bordspellen, coöperatieven of adversarielen, <br> om samen met een goede groep vrienden te spelen. \"Inderdaad\", zo sprak Darius, \"niets is zo prachtig,\"",
    options: [
    ...
    id: "board-END", title: "",
    body: "Oh, dit is gênant zeg. <br> Ik had eigenlijk niet verwacht dat je hier zou komen. <br> Nou, vooruit, uhm goed gedaan hoor, de enige plek gevonden die niet voorbereid is. <br> Gefeliciteerd.",
    options: [
    ...
    body: "Darius zet̷te zich lekker schrap, <br> een ʍnǝᴉupǝoʅƃ spel, oh dat is geen grap! <br> En terwijl hij het spel onder oͦgeͤn zag,",
    options: [
